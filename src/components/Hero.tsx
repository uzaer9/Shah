...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Scroll Indicator */}
{/* Scroll Indicator - Sleek Dot Scroll */}
<div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
  <div className="text-white text-sm mb-2">Scroll down</div>
  <div className="w-[24px] h-[40px] rounded-full border-2 border-white flex justify-center items-start relative overflow-hidden">
    <div className="w-2 h-2 bg-white rounded-full animate-scroll-dot"></div>
  </div>
</div>
